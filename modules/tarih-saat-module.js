...
//! toJSON() | Kullanıldığı değişken içeriğine atanmış olan tarih ve saat bilgilerini JSON Formatı kullanılarak düz bir metne çevirir...
var toJSONFunctionSimple = function () {
    var viewTime = new Date(),
        dataTime = typeof viewTime,
        convertTime = viewTime.toJSON(),
        dataConvert = typeof convertTime;
    document.write(viewTime + "  " + dataTime + "<br>");
    document.write(convertTime + "  " + dataConvert);
};
//! toDateString() | Kullanıldığı değişken içeriğine atanmış olan tarih ve saat bilgilerini sadece tarih kısmını alarak düz bir metne çevirir...
var toDateStringFunctionSimple = function () {
    var viewTime = new Date(),
        dataTime = typeof viewTime,
        convertTime = viewTime.toDateString(),
        dataConvert = typeof convertTime;
    document.write(viewTime + "  " + dataTime + "<br>");
    document.write(convertTime + "  " + dataConvert);
};
//! toLocaleDateString() | Kullanıldığı değişken içeriğine atanmış olan tarih ve saat bilgilerini tarayıcı lokasyonuna göre sadece tarih kısmını alarak düz bir metne çevirir...
var toLocaleDateStringFunctionSimple = function () {
    var viewTime = new Date(),
        dataTime = typeof viewTime,
        convertTime = viewTime.toLocaleDateString(),
        dataConvert = typeof convertTime;
    document.write(viewTime + "  " + dataTime + "<br>");
    document.write(convertTime + "  " + dataConvert);
};
//! toTimeString() | Kullanıldığı değişken içeriğine atanmış olan tarih ve saat bilgilerini sadece saat kısmını alarak düz bir metne çevirir...
var toTimeStringFunctionSimple = function () {
    var viewTime = new Date(),
        dataTime = typeof viewTime,
        convertTime = viewTime.toTimeString(),
        dataConvert = typeof convertTime;
    document.write(viewTime + "  " + dataTime + "<br>");
    document.write(convertTime + "  " + dataConvert);
};
